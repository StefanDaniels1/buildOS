...
1. **CO2 report file**: e.g., `batch_1_co2_report.json` (workspace root)
2. **IFC filename**: e.g., `Small_condo.ifc` (for project name)
3. **Output PDF file**: e.g., `co2_report.pdf` (workspace root)
...
**Input:**
- CO2 report: batch_1_co2_report.json
- IFC filename: Small_condo.ifc
- Output PDF: co2_report.pdf

**Your task:**
1. Verify batch_1_co2_report.json exists
2. Read the CO2 data to understand contents
3. Call the PDF generation tool
